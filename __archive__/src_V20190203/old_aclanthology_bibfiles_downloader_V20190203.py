...
"""
Version 201902xx
NOTE: This version is not compatible with the online anthology any more --> use the Version 201912xx instead
...
# local imports
from old_utils_V20190203 import FORMAT
from old_utils_V20190203 import HTML
from old_utils_V20190203 import URL
from old_utils_V20190203 import LOCAL
from old_utils_V20190203 import RESTRICTIONS
from old_utils_V20190203 import ACRONYM2LETTER_DICT
...
def __format_lines(lines):
    """
    Break up html lines with multiple tags into multiple lines.
    
    E.g. <html><head><body></body></html>
    break into
        <html>
        <head>
        <body>
